<%@page import="in.co.fly.away.ticket.controller.LoginCtl"%>
<%@page import="in.co.fly.away.ticket.controller.ATBView"%>
<%@page import="in.co.fly.away.ticket.bean.UserBean"%>
...
<title>Insert title here</title>
 <link rel="stylesheet" href="/FlyAwayTicketBooking/css/bootstrap.min.css">
  <script src="/FlyAwayTicketBooking/js/jquery.min.js"></script>
  <script src="/FlyAwayTicketBooking/js/bootstrap.min.js"></script>
